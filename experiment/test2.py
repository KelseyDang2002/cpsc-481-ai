...
class Connect_Four():
    ...
    def is_valid_location(self, col):
        return self.board[Connect_Four.ROW_COUNT - 1][col] == 0
    ...
    def get_valid_locations(self):
        ...
        for col in range(Connect_Four.COL_COUNT):
    ...
    def score_position(self, team):
        pass

    def evaluate_window(self, team):
        pass

    def pick_best_move(self, team):
        pass
